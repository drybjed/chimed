...
class Configuration(object):
    ...
    def __init__(self, args=None):
        ...
        self.merge_env(os.path.join('/etc', 'default', 'chimed'))

        # Include global chimed environment variables defined by the user
        self.merge_env(os.path.join(xdg_config_home, 'chimed', 'environment'))
        ...
        self._config_dirs = [
            '/usr/lib/chimed/conf.d',
            '/usr/local/lib/chimed/conf.d',
            '/etc/chimed/conf.d',
            os.path.join(xdg_config_home, 'chimed', 'conf.d')
        ]
        self._config_files = []
